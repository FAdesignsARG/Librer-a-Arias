...
const TAXONOMY = [
  ...
  { sub:'Utensilios de cocina', when:['vaporera','escurridor','colador','vajilla','olla','al vapor','escurreplatos','secaplatos'], tags:['cocina','hogar','organizar'], aliases:['utensilios de cocina'], audience:['adultos','familia'], ages:['adultos'], useCases:['cocinar','organizar','regalar'], environments:['cocina','hogar'], intents:['cosas para cocina','utensilios de cocina','algo para la cocina'] },
